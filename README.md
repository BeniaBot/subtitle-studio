...
**לתמלל אוטומטית**
התוכנה מאזינה לסרט וכותבת את הכתוביות לבד, עם התזמונים. השמע נשלח לגוגל רק אחרי שמאשרים את זה במפורש — וזו הפעולה היחידה בתוכנה ששולחת החוצה את התוכן עצמו.
*(דורש חיבור לאינטרנט ואותו מפתח חינמי מגוגל.)*
