...
namespace SubtitleStudio
{
    ...
    internal static class Theme
    {
        ...
        ///
        /// עד 0.8.1 הזמנים היו ב-Consolas, גופן מכונת כתיבה, ליד גופן הממשק - שני
        /// עולמות באותה שורה. כל ספרה מצוירת במרכז תא ברוחב אחיד, כך ששעון רץ לא
        /// ״רוקד״ כשמתחלפת ספרה. ב-IBM Plex הספרות כבר אחידות (8.9 כל אחת); ב-Assistant
        /// ה-1 היה צר בפיקסל - והתא מגן גם מפני גופן כזה.
