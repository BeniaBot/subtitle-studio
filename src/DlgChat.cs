...
namespace SubtitleStudio
{
    ...
    internal class AiChatForm : Form
    {
        ...
        private string SystemPrompt()
        {
            ...
            sb.Append("**איך מתחילים כתוביות מאפס** - זו השאלה הנפוצה ביותר, ויש בדיוק שלוש תשובות:\n");
            ...
            sb.Append("אם לא ברור לך באיזה מצב המשתמש - שאל שאלה אחת קצרה, ואל תסביר את כל השלוש.\n\n");
