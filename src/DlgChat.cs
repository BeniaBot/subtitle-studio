...
namespace SubtitleStudio
{
    ...
    internal class AiChatForm : Form
    {
        ...
        private string SystemPrompt()
        {
            ...
            sb.Append("כשאפשר לבצע את הבקשה - קרא לפונקציה המתאימה במקום להסביר איך עושים את זה ידנית. ");
            sb.Append("אל תמציא נתונים: אם חסר לך מידע על הכתוביות, קרא ל-get_state או list_cues. ");
            sb.Append("פעולות ארוכות או הרסניות מבקשות אישור מהמשתמש בעצמן - אל תשאל אישור פעמיים. ");
